...
<div className="grid grid-cols-1 md:grid-cols-12 gap-4 mb-10 items-stretch">
  ...
  {/* 2. THALAIVAR (Mobile: 1st/Top, Desktop: 2nd/Center) */}
  ...
  {/* 3. RIGHT COLUMN (Mobile: 3rd/Bottom, Desktop: 3rd/Right) */}
